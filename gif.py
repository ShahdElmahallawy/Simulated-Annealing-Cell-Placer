...
def create_grid_image(grid, cell_size=20, font_size=8):
    ...
    font = ImageFont.truetype("arial.ttf", font_size)  # Adjust the font path as needed
...
def generate_animation(file_path, output_gif, cell_size=20, font_size=8):
    images = []
...
generate_animation('out\\grid_states_d1.txt', 'gif\\placement_progress_d1.gif')
